        ...
        <div class="container d-flex align-items-center justify-content-lg-between">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="nav-link scrollto " href="{{route('attorney.index',['id'=>'id'])}}">Cases</a></li>
                    <li><a class="nav-link scrollto " href="{{route('attorney.assign')}}">Assign Cases to Attornies</a></li>
