        ...
        <div class="container d-flex align-items-center justify-content-lg-between">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="nav-link scrollto " href="{{route('detective.index',['id'=>'id'])}}">Cases</a></li>
                    <li><a class="nav-link scrollto " href="{{route('detective.assign')}}">Assign Cases to Detectives</a></li>
