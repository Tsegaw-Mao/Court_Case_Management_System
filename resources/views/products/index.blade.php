...
<div class="card">
    ...
    <div class="card-body">
        @can('create-product')
            <a href="{{ route('products.create') }}" class="btn btn-success btn-sm my-2"><i class="bi bi-plus-circle"></i> Add New documents</a>
        @endcan
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('products.destroy', $product->id) }}" method="post">
                            ...
                            @can('delete-product')
                                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Do you want to delete this document?');"><i class="bi bi-trash"></i> Delete</button>
                            @endcan
                        </form>
                    </td>
                </tr>
